	...
	<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">
            ...
            <nav class="xs-menu displaynone">
					<ul>
						...
						<li><a href="internationalstaff.php">International Staff</a></li>
						<li class="active"><a href="parliamentstaff.php">Parliament Staff</a></li>
						<li>		
...
<div class="col-lg-8 col-md-11 col-sm-11 col-xs-11"  style="border: 0px solid #666666; 
	...
	<?php
		$sql="select * from user where user.department = 'Parliament' order by role ASC";
   ...
   <div class="newscont col-lg-12 col-md-11 col-sm-12 col-xs-12" style="border: 1px solid #666666; margin-left:15px; 
    ...
    <div class="col-lg-offset-6 col-md-6 col-sm-12 col-xs-12"  style="margin-left:10px; 
		...
		</th><th style="align:right;"><a href="paredituser.php?userId='.$ui.'&firstName='.$fn.'&secondName='.$sn.'&lastName='.$ln.'
