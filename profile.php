 ...
 <div class="masthead" >
	 ...
	 ?>
      ...
      <div class="row wow fadeInUp" >
       ...
       <div class="col-lg-8 col-md-11 col-sm-11 col-xs-11 newscont"  style="border: 1px solid #666666; margin-left:15px; 
         margin-right: -15px; border-radius: 7px;  margin-top: 5px;" id="newscont">
        <h1 style="text-align:center;font-size:24px;">Welcome </h1>
		<div class="container height:auto; border:1px;">
		<div class="row">
    ...
    <div class="col-lg-offset-6 col-md-6 col-sm-12 col-xs-12"  style="margin-left:15px; 
         margin-right: 0px; border-radius: 7px;  margin-top: 5px; height:auto;">   
