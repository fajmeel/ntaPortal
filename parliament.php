			...
			<a id="menutoggle" ><i class="glyphicon glyphicon-align-justify"></i> </a>
             <nav class="xs-menu displaynone">
					<ul>
						...
						<li class="active"><a href="parliament.php">Parliament</a></li>
						<li>		
...
<div class="col-lg-8 col-md-11 col-sm-11 col-xs-11"  style="border: 0px solid #666666; 
	...
	<?php
		$sql="select * from user inner join post on user.userId=post.postBy where user.department = 'parliament' order by date DESC";
