...
<div class="wow fadeInDown">
	...
	<div class="col-md-6"> 
		...
		<div class="col-md-6"> 
			<div class="form-group">
			<a type="button" value="Reset"href="news24staff.php" class="btn btn-danger btn-md btn-block">Discard Changes</a>
			</div>
		</div>
	</div>
		...
		//alert(data)
			if(data){
			  ...
			  $.ajax({
						...
						window.location="news24staff.php"
