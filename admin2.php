           ...
           <div class="container" style="margin-top: -1px;" >
			...
			<a id="menutoggle" ><i class="glyphicon glyphicon-align-justify"></i> </a>
             <nav class="xs-menu displaynone">
					<ul>
						...
						<li><a href="admin2.php">ALL USERS</a></li>
						<li><a href="network.php">NETWORK</a></li>
						<li><a href="news24.php">NEWS24</a></li>
						<li><a href="international.php">INTERNATIONAL</a></li>
						<li><a href="international.php">PARLIAMENT</a></li>
						<li>		
			...
			<nav class="menu">
				<ul><li><a href="#">HOME</a>	</li>
					<li class="active"><a href="admin2.php">ALL USERS</a></li>
					<li><a href="network.php">NETWORK</a></li>
					<li><a href="news24.php">NEWS24</a></li>
					<li><a href="international.php">INTERNATIONAL</a></li>
					<li><a href="international.php">PARLIAMENT</a></li>				
...
<div class="col-lg-8 col-md-11 col-sm-11 col-xs-11"  style="border: 0px solid #666666; 
   ...
   <div class="newscont col-lg-12 col-md-11 col-sm-12 col-xs-12" style="border: 1px solid #666666; margin-left:15px; 
    ...
    <div class="col-lg-offset-6 col-md-6 col-sm-12 col-xs-12"  style="margin-left:10px; 
		...
		</th><th style="align:right;"><a href="edituser.php?userId='.$ui.'&firstName='.$fn.'&secondName='.$sn.'&lastName='.$ln.'
  ...
  margin-left:15px; position:relative;">
	...
	<div style="text-align:right; width:305px;"><a href="http://www.surfing-waves.com/feed.htm" target="_blank" style="color:#ccc;font-size:10px"></div> 
